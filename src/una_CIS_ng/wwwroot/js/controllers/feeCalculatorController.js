...
(function (angular) {
  ...
  function feeCalculatorController($scope) {
    ...
    $scope.calc.fees.push({ "feeType": "application", "condition": "(calc.infState == 'New' || calc.infState == 'Decommissioning') && (calc.infType == 'TransTower' || calc.infType == 'OtherTower' || calc.infType == 'Dish')", "name": "Construction Permit Fee - Tower / Mast / Dish", "unit": 1, "divider": 1, "measure": "", "rate": 20000, "total": 0 });
    $scope.calc.fees.push({ "feeType": "application", "condition": "(calc.infState == 'New' || calc.infState == 'Decommissioning') && calc.infType == 'Underground'", "name": "Construction Permit Fee - Underground", "unit": 1, "divider": 1, "measure": "", "rate": 10000, "total": 0 });
    ...
    $scope.calc.fees.push({ "feeType": "application", "condition": "calc.infState != 'Decommissioning' && (calc.permState == 'New' || calc.permState == 'Temporary') && calc.infType == 'Underground' && calc.consType == 'HorizontalDrilling'", "name": "Application Permit Fee - Underground Horizontal Drilling", "unit": 0, "divider": 1, "rate": 500, "measure": "metre", "total": 0 });
    $scope.calc.fees.push({ "feeType": "application", "condition": "calc.infState != 'Decommissioning' && (calc.permState == 'New' || calc.permState == 'Temporary') && calc.infType == 'Underground' && calc.consType == 'HorizontalDrilling'", "name": "Application Permit Fee - Underground Horizontal Drilling Pits(x2)", "unit": 0, "divider": 1, "rate": 6000, "measure": "section", "total": 0 });
    $scope.calc.fees.push({ "feeType": "application", "condition": "calc.infState != 'Decommissioning' && (calc.permState == 'New' || calc.permState == 'Temporary') && calc.infType == 'Underground' && calc.consType == 'Trenching'", "name": "Application Permit Fee - Underground Trenching", "unit": 0, "divider": 1, "rate": 3000, "measure": "metre", "total": 0 });
    $scope.calc.fees.push({ "feeType": "application", "condition": "calc.infState != 'Decommissioning' && (calc.permState == 'New' || calc.permState == 'Temporary') && calc.infType == 'Underground'", "name": "Application Permit Fee - Remediation", "unit": 0, "divider": 1, "rate": 10000, "measure": "metre", "total": 0 });
